...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    private void getFriendList(){
        OkGo.<String>get("http://114.116.66.158:8081/api/user/contact/list").tag(this)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(userInfoBean.getCode()==200){
                            EaseConstant.friendList=userInfoBean.getData();
                            getContactList();
                            //init list
            ...
            while (iterator.hasNext()) {
                ...
                if (!entry.getKey().equals("item_new_friends")
                    ...
                    if(!blackList.contains(entry.getKey())){
                        ...
                        if(null!=EaseConstant.friendList){
                            for(int i=0;i<EaseConstant.friendList.size();i++){
                                if(EaseConstant.friendList.get(i).getUsername().equals(user.getUsername())){
                                    user.setNickname(EaseConstant.friendList.get(i).getNick_name());
                                    user.setNick(EaseConstant.friendList.get(i).getNick_name());
