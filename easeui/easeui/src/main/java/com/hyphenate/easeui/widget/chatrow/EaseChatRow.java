...
//                Glide.with(getContext()).load(message.getStringAttribute(EaseConstant.ATTR_PHOTO)).apply(options).into(userAvatarView);
...
//                    Glide.with(getContext()).load(message.getStringAttribute(EaseConstant.ATTR_PHOTO)).apply(options).into(userAvatarView);
//
//                    usernickView.setText(message.getStringAttribute(EaseConstant.ATTR_NICKNAME));
