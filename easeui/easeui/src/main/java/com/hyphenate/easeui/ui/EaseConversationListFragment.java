...
public class EaseConversationListFragment extends EaseBaseFragment{
    ...
    protected void initView() {
        ...
        uploadContact_layout = (LinearLayout) getView().findViewById(R.id.uploadContact_layout);
        uploadContact_layout.setOnClickListener(new OnClickListener() {
            @Override
    ...
    protected List<EMConversation> loadConversationList(){
        ...
        synchronized (conversations) {
            for (EMConversation conversation : conversations.values()) {
                if (conversation.getAllMessages().size() != 0&& EaseTopUtils.isEnableMsgTop(getActivity(),EaseConstant.USER_ID,conversation.conversationId()) ) {
