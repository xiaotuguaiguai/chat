...
public class Constant extends EaseConstant{
	...
	public static String USERPSWKEY ="userPsw";
	...
	public static String client_secret	="ERTPCHYrKVoUN28QGsjqTl5422xqWwhm5jLkvWIK";
	public static String scope	="*";

	public static int window_x,window_y;//屏幕宽高
}
