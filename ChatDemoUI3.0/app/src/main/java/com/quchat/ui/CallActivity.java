...
//        message.setAttribute(EaseConstant.ATTR_PHOTO,info.getString(EaseConstant.ATTR_PHOTO));
//        message.setAttribute(EaseConstant.ATTR_TOPHOTO,info.getString(EaseConstant.ATTR_TOPHOTO));
//        message.setAttribute(EaseConstant.ATTR_NICKNAME,info.getString(EaseConstant.ATTR_NICKNAME));
//        message.setAttribute(EaseConstant.ATTR_TONICKNAME,info.getString(EaseConstant.ATTR_TONICKNAME));
        // set message body
