...
//        Log.e("ss",super.info.getString(EaseConstant.ATTR_PHOTO));
        ...
        swing_card= (CircleImageView) findViewById(R.id.swing_card);
    ...
    private String getNickName(){
        for (int i = 0; i<TempCache.friendList.size(); i++){
            ...
            if(username.equals(data.getUsername())){
                ...
                Glide.with(this).load(data.getHead_url()).apply(options).into(swing_card);
