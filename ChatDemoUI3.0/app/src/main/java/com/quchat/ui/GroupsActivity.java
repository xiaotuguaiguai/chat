...
import com.quchat.R;
import com.quchat.adapter.GroupAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				if (position == 1) {
					// create a new group
					startActivityForResult(new Intent(GroupsActivity.this, GroupPickContactsActivity.class), 100);
				} else {
					// enter group chat
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode==RESULT_OK){
			if(requestCode==100){
				...
				Log.e("ss",content);
				startActivity(new Intent(GroupsActivity.this,ChatActivity.class)
