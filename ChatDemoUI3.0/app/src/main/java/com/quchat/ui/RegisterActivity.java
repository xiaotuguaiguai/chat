...
public class RegisterActivity extends BaseActivity {
	...
	private void auth() {
		...
		progressDialog = ProgressDialog.show(this,"","注册中");
...
//		if (StringUtils.isEmpty(userNameEditText.getText().toString())) {
...
//		}
//
//		if (passwordEditText.getText().toString().length() < 6 || confirmPwdEditText.getText().toString().length() < 6) {
//			Toast.makeText(this, "请输入6位以上的密码", Toast.LENGTH_SHORT).show();
//
//			return;
//		}
//
//		if (StringUtils.isEmpty(passwordEditText.getText().toString())
//				||
//				StringUtils.isEmpty(confirmPwdEditText.getText().toString())
//				) {
//			Toast.makeText(this, "请输入密码", Toast.LENGTH_SHORT).show();
//
//			return;
//		}
//		if (!confirmPwdEditText.getText().toString().equals(confirmPwdEditText.getText().toString())) {
