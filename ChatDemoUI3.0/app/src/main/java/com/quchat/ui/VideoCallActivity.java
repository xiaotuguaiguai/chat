...
import com.quchat.utils.PhoneStateManager;
...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    private LinearLayout qiehuan_layout;
...
//        super.info=getIntent().getExtras();
        ...
        answerBtn = (LinearLayout) findViewById(R.id.btn_answer_call);
        hangupBtn = (RelativeLayout) findViewById(R.id.btn_hangup_call);
...
//        recordBtn = (Button) findViewById(R.id.btn_record_video);
        ...
        qiehuan_layout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(VideoCallActivity.this,"暂未开通",Toast.LENGTH_SHORT).show();
            }
        });
...
//        recordBtn.setOnClickListener(this);
    ...
    private String getNickName(){
        for (int i = 0; i<TempCache.friendList.size(); i++){
            ContactListBean.MyData data = TempCache.friendList.get(i);
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
        ...
        */
        ...
        case R.id.btn_switch_camera: //switch camera
            ...
            if(isCameraBack){
                switchCameraBtn.setBackground(getResources().getDrawable(R.drawable.icon_zhuanhuan_done));
            }else {
                switchCameraBtn.setBackground(getResources().getDrawable(R.drawable.icon_zhuanhuan));
