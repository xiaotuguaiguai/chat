...
import com.quchat.domain.InviteMessage;
import com.quchat.domain.InviteMessage.InviteMessageStatus;
import com.quchat.domain.RobotUser;
import com.quchat.parse.UserProfileManager;
import com.quchat.receiver.CallReceiver;
import com.quchat.receiver.HeadsetReceiver;
import com.quchat.ui.ChatActivity;
import com.quchat.ui.MainActivity;
import com.quchat.ui.VideoCallActivity;
import com.quchat.ui.VoiceCallActivity;
import com.quchat.utils.JsonUitl;
import com.quchat.utils.PreferenceManager;
...
//	}
    private EaseUser getUserInfo(String username) {
        ...
        try {
            ...
            if (username.equals(Constant.USERNAME)){
                easeUser.setNick(TempCache.UserBean.getData().getNick_name());
                easeUser.setAvatar(TempCache.UserBean.getData().getHead_url());
            }else {

                for(int i=0;i<TempCache.friendList.size();i++){
                    ContactListBean.MyData myData = TempCache.friendList.get(i);
                    if(myData.username.equals(username)){
                        easeUser.setNick(myData.getNick_name());
                        easeUser.setAvatar(myData.getHead_url());
                        break;
                    }
                }
    ...
    private void getFriendList(){
        OkGo.<String>get(URL.GETFRIENDLIST).tag(appContext)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(userInfoBean.getCode()==200){
                            TempCache.friendList=userInfoBean.getData();
                        }
                    }
